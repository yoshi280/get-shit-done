...
```bash
INIT=$(node /Users/thelorax/.claude/get-shit-done/bin/gsd-tools.cjs init new-project)
```
...
```bash
mkdir -p .planning
node /Users/thelorax/.claude/get-shit-done/bin/gsd-tools.cjs commit "chore: add project config" --files .planning/config.json
```

**Persist auto-advance to config (survives context compaction):**

```bash
node /Users/thelorax/.claude/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance true
```
...
```bash
mkdir -p .planning
node /Users/thelorax/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: initialize project" --files .planning/PROJECT.md
```
...
Task(prompt="First, read /Users/thelorax/.claude/agents/gsd-project-researcher.md for your role and instructions.
...
Use template: /Users/thelorax/.claude/get-shit-done/templates/research-project/SUMMARY.md
...
```bash
node /Users/thelorax/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node /Users/thelorax/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
...
- [ ] Research completed (if selected) — N parallel agents spawned (user-selected dimensions) → **committed**
