...
Use template from `/Users/thelorax/.config/opencode/get-shit-done/templates/roadmap.md`.
...
Use template from `/Users/thelorax/.config/opencode/get-shit-done/templates/state.md`.
