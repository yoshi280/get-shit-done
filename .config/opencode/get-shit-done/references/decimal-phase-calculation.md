...
node /Users/thelorax/.config/opencode/get-shit-done/bin/gsd-tools.js phase next-decimal 6
```
...
Or with --raw flag:
```bash
DECIMAL_PHASE=$(node /Users/thelorax/.config/opencode/get-shit-done/bin/gsd-tools.js phase next-decimal "${AFTER_PHASE}" --raw)
# Returns just: 06.1
```
