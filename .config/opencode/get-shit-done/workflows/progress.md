...
```bash
INIT=$(node /Users/thelorax/.config/opencode/get-shit-done/bin/gsd-tools.js init progress --include state,roadmap,project,config)
```
...
**Profile:** [quality/balanced/budget/openai-codex/gemini-pro]
