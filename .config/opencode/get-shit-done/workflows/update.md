...
if [ -f "./.claude/get-shit-done/VERSION" ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/thelorax/.config/opencode/get-shit-done/VERSION ]; then
  cat /Users/thelorax/.config/opencode/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/thelorax/.config/opencode/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/thelorax/.config/opencode/cache/gsd-update-check.json
```
</step>
